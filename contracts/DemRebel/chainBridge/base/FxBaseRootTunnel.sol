...
abstract contract FxBaseRootTunnel is Modifiers {
    ...
    bytes32 constant SEND_MESSAGE_EVENT_SIG =
        0x8c5261668696ce22758910d05bab8f186d6eb247ceac2af2e82c7dc17669b036;

    // set fxChildTunnel if not set already
    function setFxChildTunnel(address _fxChildTunnel) public virtual {
        require(
            s.fxChildTunnel == address(0x0),
    ...
    function _sendMessageToChild(bytes memory message) internal {
        s.fxRoot.sendMessageToChild(s.fxChildTunnel, message);
    }
    ...
    function _validateAndExtractMessage(
        ...
        // check child tunnel
        require(
            s.fxChildTunnel == log.getEmitter(),
    ...
    function _checkBlockMembershipInCheckpoint(
        ...
        (bytes32 headerRoot, uint256 startBlock, , uint256 createdAt, ) = s
            .checkpointManager
